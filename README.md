...
3. [How to Run the Automated Tests in `IntelliJ`](#how-to-run-the-automated-tests-in-intellij)
4. [How to Run the Automated Tests in `Terminal`](#how-to-run-the-automated-tests-in-terminal)
...
## How to Run the Automated Tests in `IntelliJ`
...
## How to Run the Automated Tests in `Terminal`
1. Clone or downlaod this repository.
...
13. Repeat steps 6-12. After adding the happy path(s) for each test scenario, add the edge cases. Then move on to the next test scenario.
